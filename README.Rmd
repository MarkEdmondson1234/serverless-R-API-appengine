...
8. Deploy the openapi.yaml in terminal via `gcloud service-management deploy openapi.yaml --project mark-edmondson-usa`
9. Run `gcloud service-management configs list --service=example-project.appspot.com` to see the service management name and config you just uploaded
